...
/**
 * This is the main facebook class that will have methods which return facebook
 * data as well as publish data to facebook This is a work in progress.
 * 
...
public class Facebook implements Serializable {
	...
	public Facebook(OAuthAccessToken authAccessToken) {
		this(authAccessToken, HttpClientType.APACHE_HTTP_CLIENT); // apache http
																	// client is
																	// the
																	// default
																	// client
	...
	public User getUser(String username) throws FacebookException {
		...
		userJson = caller.getData(
				Constants.FACEBOOK_GRAPH_URL + "/" + username, nameValuePairs);
	...
	/*
	 * public Album getAlbum(long id) throws FacebookException{ NameValuePair[]
	 * nameValuePairs = {getNameValuePairAccessToken()}; String albumJson =
	...
	private NameValuePair getNameValuePairAccessToken() {
		return new NameValuePair(Constants.PARAM_ACCESS_TOKEN,
				this.authAccessToken.getAccessToken());
	}
